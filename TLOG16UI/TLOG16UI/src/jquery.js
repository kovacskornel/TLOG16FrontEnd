...
$(document).ready(function () {
    ...
    function printCalendar(date) {
        ...
        console.log("Loading json...");
            ...
            traditional: true,
            error: console.log("Failed loading: " + "http://127.0.0.1:9090/tlog-backend/timelogger/workmonths/" + actmonth.getFullYear().toString() + "/" + (actmonth.getMonth() + 1).toString()),
